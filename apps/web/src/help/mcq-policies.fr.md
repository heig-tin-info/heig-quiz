...
- **Tout ou rien** — 1 si l'ensemble coché est exactement la clé, 0 sinon.
- **Vrai-faux par proposition** — chaque proposition est un vrai-faux à part entière : `(c + (W - w)) / (C + W)`. Ne rien cocher rapporte déjà `W / (C + W)`.
- **Discordances** — on compte les propositions prises à l'envers, dans un sens comme dans l'autre : `d = (C - c) + w`. Aucune discordance vaut 1, une vaut 0,5, deux valent 0,2, trois ou plus valent 0.
