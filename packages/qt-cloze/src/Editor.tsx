 ...
 * parser understood.
 *
 * Controlled and offline. The blank table is the whole point of the screen: the
 * `{{…}}` grammar is terse, so the teacher must SEE how each hole was read —
 ...
 */
import type { ConfigIssue, EditorProps, StringOverrides } from "@quiz/core/client";
...
import { cx, helpClass, inputClass, IssueList, issuesAt, labelClass, rootIssues, sectionClass } from "./ui.js";
